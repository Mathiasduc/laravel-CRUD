...
function listeners() {
	var addOneNodeList = document.querySelectorAll('.addOne');
	addEventListenerList(addOneNodeList, 'click', addOneToStock);

	var deleteOneNodeList = document.querySelectorAll('.deleteOne');
	addEventListenerList(deleteOneNodeList, 'click', deleteOneStock);

	var deleteProductNodeList = document.querySelectorAll('.deleteProduct');
